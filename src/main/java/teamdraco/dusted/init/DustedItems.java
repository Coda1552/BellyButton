...
public class DustedItems {
    ...
    public static final RegistryObject<Item> LINT = REGISTER.register("lint", () -> new Item(new Item.Properties().tab(Dusted.GROUP)));
    ...
    public static final RegistryObject<Item> ITCHY_SWEATER = REGISTER.register("itchy_sweater", () -> new LintSweaterItem(ArmorMaterials.LEATHER, EquipmentSlot.CHEST, new Item.Properties().tab(Dusted.GROUP).stacksTo(1)));
    ...
    public static final RegistryObject<Item> LINT_BLOCK = REGISTER.register("lint_block", () -> new BlockItem(DustedBlocks.LINT_BLOCK.get(), new Item.Properties().tab(Dusted.GROUP)));
    public static final RegistryObject<Item> LINT_CARPET = REGISTER.register("lint_carpet", () -> new BlockItem(DustedBlocks.LINT_CARPET.get(), new Item.Properties().tab(Dusted.GROUP)));
