...
public class DustedEffects {
    ...
    public static void brewingRecipes() {
        BrewingRecipeRegistry.addRecipe(Ingredient.of(PotionUtils.setPotion(new ItemStack(Items.POTION), Potions.AWKWARD)), Ingredient.of(DustedItems.DUST.get()), PotionUtils.setPotion(new ItemStack(Items.POTION), ITCHY_NORMAL.get()));
