...
public class BellyButtonEntities {
    ...
    public static final RegistryObject<EntityType<EvilDustBunnyProjectileEntity>> EVIL_DUST_BUNNY_PROJECTILE = create("evil_dust_bunny_projectile", EntityType.Builder.create(EvilDustBunnyProjectileEntity::new, EntityClassification.MISC).size(1.0f, 1.0f));
